...
def upgrade() -> None:
    ...
    sa.PrimaryKeyConstraint('stage_id', name=op.f('pk_pipeline_stage'))
    )
    op.create_table('pipeline_status',
    sa.Column('status_id', sa.Integer(), nullable=False),
    sa.Column('status_name', sa.String(), nullable=False),
    sa.Column('description', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('status_id', name=op.f('pk_pipeline_status'))
    )
    ...
    sa.UniqueConstraint('origin_id', name=op.f('uq_orders_origin_id'))
    )
    ...
    sa.Column('description', sa.String(), nullable=False),
    sa.ForeignKeyConstraint(['order_id'], ['orders.order_id'], name=op.f('fk_pipeline_execution_order_id_orders')),
    sa.ForeignKeyConstraint(['stage_id'], ['pipeline_stage.stage_id'], name=op.f('fk_pipeline_execution_stage_id_pipeline_stage')),
    sa.ForeignKeyConstraint(['status_id'], ['pipeline_status.status_id'], name=op.f('fk_pipeline_execution_status_id_pipeline_status')),
    sa.PrimaryKeyConstraint('pipeline_id', name=op.f('pk_pipeline_execution'))
    )
